...
export const SCENARIOS = [
  {
    ...
    evidence: [
      ...
      { id: 'eg_6', name: "Worn Human Teeth", type: "remains", discoveryMethod: "Taken from a jawbone and looked at under a microscope.", clue: "Human teeth that are ground down and very flat.", question: "What could worn human teeth help archaeologists understand about daily life?", options: ["They suggest people used their teeth mainly as tools for leatherwork.", "They suggest diet and food preparation affected people's health.", "They suggest everyone had the same genetic tooth problem.", "They suggest people sharpened teeth to show warrior status."], correct: 1, labResult: "These human teeth are worn down. The surface shows signs of heavy use over time.", rationale: "Worn teeth can reveal information about diet, health and how food was prepared." },
  ...
  },
  {
    ...
    evidence: [
      ...
      { id: 'ch_12', name: "Millet Seeds", type: "environment", discoveryMethod: "Sifted from an old fireplace in the north.", clue: "Tiny seeds of a grain that grows in dry places.", question: "What can millet seeds suggest about farming in northern China?", options: ["Millet was used only to feed pet birds.", "People grew crops suited to dry conditions.", "Millet seeds were mainly used to make concrete.", "Millet was only a weed that grew by accident."], correct: 1, image: "museum/china_millet_seeds.jpg", rationale: "Millet seeds help historians understand farming choices, climate and diet." },
      ...
      { id: 'ch_14', name: "Bamboo Slips", type: "written", discoveryMethod: "Dug up from a dry tomb and unrolled carefully.", clue: "Strips of bamboo tied together with writing on them.", question: "What can bamboo slips with writing suggest about government or learning?", options: ["They suggest information could be recorded, stored and shared.", "They were mainly used as building material.", "They were only used as firewood.", "They were mainly used as musical instruments."], correct: 0, image: "museum/china_bamboo_slips.jpg", rationale: "Bamboo slips are written evidence that can reveal administration, laws, learning or records." },
      { id: 'ch_15', name: "Bronze Inscription", type: "written", discoveryMethod: "Cleaned carefully in a lab.", clue: "Symbols carved inside a metal ritual pot.", question: "What can writing cast into bronze suggest?", options: ["It suggests bronze objects were only decorative.", "It suggests important messages, ownership, power or ritual memory could be preserved.", "It suggests writing was used only by farmers.", "It suggests bronze was used mainly because paper was unavailable."], correct: 1, image: "museum/china_bronze_inscription.jpg", rationale: "Bronze inscriptions can preserve official, ritual or family messages and reveal power, memory and belief." }
    ]
  }
];
