...
export const SCENARIOS = [
  ...
  },
  {
    ...
    evidence: [
      ...
      { id: 'ch_5', name: "Silk-Wrapped Bones", type: "remains", discoveryMethod: "Studied under a microscope to find tiny fibers.", clue: "Human bones that have tiny bits of silk thread on them.", question: "What do silk fibres found with human bones tell us?", options: ["The silk probably came from spiders in the tomb.", "Silk was only used as a medical bandage.", "It shows skilled silk production and high-status clothing or burial practice.", "Silk was used only for religious decorations."], correct: 2, image: "museum/china_silk_wrapped_bones.png", rationale: "Silk fibres reveal technology, clothing, status and burial customs." },
      { id: 'ch_6', name: "Laborer Skeletons", type: "remains", discoveryMethod: "Found buried together inside a large wall.", clue: "Skeletons showing signs of hard work and not enough food.", question: "What do skeletons showing hard work and poor nutrition tell us?", options: ["They were athletes who died during a race.", "They were soldiers who died defending the wall.", "They were buried only to make the wall stronger.", "They show forced labour and the human cost of large building projects."], correct: 3, image: "museum/china_laborer_skeletons.png", rationale: "Human remains provide evidence about labour, health, inequality and the cost of major construction." },

      { id: 'ch_7', name: "Rammed Earth Wall", type: "structures", discoveryMethod: "Measured with GPS and soil samples.", clue: "A massive wall made of very tightly packed dirt.", question: "What does a massive rammed earth wall tell us about government organisation?", options: ["Leaders could organise workers, materials and large construction projects.", "It was mainly built to stop fields from flooding.", "It was only a farm boundary marker.", "It was mainly a raised road."], correct: 0, image: "museum/china_rammed_earth_wall.png", rationale: "Large walls show organisation, planning, labour and political power." },
      { id: 'ch_8', name: "Wooden Pagoda Foundation", type: "structures", discoveryMethod: "Dug up to show the stone bases for tall wooden poles.", clue: "A square base made to hold up a very tall wooden tower.", question: "What does a strong foundation for a tall wooden structure tell us?", options: ["It was mainly built to hold a giant statue.", "It shows advanced building knowledge and vertical architecture.", "It was only a lookout for fires.", "It was mainly built to protect wood from animals."], correct: 1, image: "museum/china_wooden_pagoda.png", rationale: "Foundations reveal construction methods, engineering and religious or cultural buildings." },
      { id: 'ch_9', name: "Ceramic Kiln", type: "structures", discoveryMethod: "Found near a huge pile of ash and broken pots.", clue: "A large oven built into a hillside.", question: "What does a large ceramic kiln tell us about production and technology?", options: ["It was used mainly to bake sacred bread.", "People produced pottery using specialised technology.", "It was mainly a heater for a village.", "It was mainly a furnace for bronze weapons."], correct: 1, image: "museum/china_ceramic_kiln.png", rationale: "A kiln shows craft production, technology and specialised work." },

      { id: 'ch_10', name: "Rice Grains", type: "environment", discoveryMethod: "Found in a wet pit using water to float the seeds.", clue: "Burnt grains of farmed rice.", question: "What do burnt rice grains tell us about food and farming?", options: ["Rice farming was important for food.", "Rice was used only for special wine.", "Rice was always imported as a luxury.", "Rice was used mainly to pay workers."], correct: 0, image: "museum/china_rice_grains.png", rationale: "Plant remains reveal farming, diet and environmental adaptation." },
      { id: 'ch_11', name: "Mulberry Leaves", type: "environment", discoveryMethod: "Found inside a sealed jar.", clue: "Leaves from a Mulberry tree.", question: "What do mulberry leaves tell us about silk production?", options: ["They were grown mainly for medicinal tea.", "They may have been used to feed silkworms for silk production.", "They were mainly used as building material.", "They were grown only to feed farm animals."], correct: 1, image: "museum/china_mulberry_leaves.png", rationale: "Mulberry leaves connect environmental evidence to silk technology and economic activity." },
      { id: 'ch_12', name: "Millet Seeds", type: "environment", discoveryMethod: "Sifted from an old fireplace in the north.", clue: "Tiny seeds of a grain that grows in dry places.", question: "What do millet seeds tell us about farming in northern China?", options: ["Millet was used only to feed pet birds.", "People grew crops suited to dry conditions.", "Millet seeds were mainly used to make concrete.", "Millet was only a weed that grew by accident."], correct: 1, image: "museum/china_millet_seeds.png", rationale: "Millet seeds help historians understand farming choices, climate and diet." },

      { id: 'ch_13', name: "Oracle Bone", type: "written", discoveryMethod: "Dug up and studied by language experts.", clue: "A turtle shell with symbols carved into it.", question: "What does an oracle bone tell us about belief and writing?", options: ["People used writing to try and communicate with spirits or predict the future.", "It was mainly used as expensive money.", "It was only a secret merchant code.", "It was only a decorative plaque."], correct: 0, image: "museum/china_oracle_bone.png", rationale: "Oracle bones show early writing and beliefs about prophecy, ancestors or spirits." },
      { id: 'ch_14', name: "Bamboo Slips", type: "written", discoveryMethod: "Dug up from a dry tomb and unrolled carefully.", clue: "Strips of bamboo tied together with writing on them.", question: "What do bamboo slips with writing tell us about government or learning?", options: ["Information could be recorded, stored and shared.", "They were mainly used as building material.", "They were only used as firewood.", "They were mainly used as musical instruments."], correct: 0, image: "museum/china_bamboo_slips.png", rationale: "Bamboo slips are written evidence that reveal administration, laws, learning or records." },
      { id: 'ch_15', name: "Bronze Inscription", type: "written", discoveryMethod: "Cleaned carefully in a lab.", clue: "Symbols carved inside a metal ritual pot.", question: "What does writing cast into bronze tell us?", options: ["Bronze objects were only decorative.", "Important messages, ownership, power or ritual memory could be preserved.", "Writing was used only by farmers.", "Bronze was used mainly because paper was unavailable."], correct: 1, image: "museum/china_bronze_inscription.png", rationale: "Bronze inscriptions preserve official, ritual or family messages and reveal power, memory and belief." }
    ]
  }
];
