...
const BUREAU_CASES_RAW = [
  {
    ...
    caseTitle: 'The River Clue',
    dateRange: '3150 BC - 30 BC',
    tier1SiteClue: 'This civilisation grew beside the Nile River in north-east Africa.',
    tier2SocietyClue: 'It was ruled by Pharaohs, who were powerful leaders.',
    tier3LegacyClue: 'It left behind pyramids, tombs, mummies, and hieroglyphic writing.',
    civilisationOptions: [
      'Ancient Egypt',
    ...
    historianLogOptions: [
      'The river clue helped, but it could fit more than one civilisation.',
      'The Pharaoh and pyramid clue was strongest because it points clearly to Ancient Egypt.',
      'The farming clue was interesting, but it was not enough by itself.',
      'The date helped, but it was not the clearest clue.',
    ],
    correctHistorianLogAnswer: 1,
    explanation: 'Correct. The river clue helped, but Pharaohs, pyramids, and hieroglyphics point much more clearly to Ancient Egypt.',
    comparisonTags: ['trade', 'records', 'river'],
  },
  {
    id: 'bureau_2',
    civilisation: 'Indus Valley Civilisation',
    caseTitle: 'The Old City Clue',
    dateRange: '2600 BC - 1900 BC',
    tier1SiteClue: 'This civilisation grew near the Indus River in parts of modern India and Pakistan.',
    tier2SocietyClue: 'Its cities were carefully planned, with straight streets and drainage systems.',
    tier3LegacyClue: 'It left behind cities like Harappa and Mohenjo-daro, plus seals and writing that historians still cannot fully read.',
    civilisationOptions: [
      'Indus Valley Civilisation',
      'Ancient Egypt',
      'Ancient China',
    ...
    historianLogQuestion: 'Which clue was the strongest evidence?',
    historianLogOptions: [
      'The river clue was broad and could fit several early civilisations.',
      'The planned cities, drains, Harappa, Mohenjo-daro, and unread script were the strongest clues.',
      'A seal was useful, but by itself it was not enough.',
      'The date helped, but it did not point clearly enough.',
    ],
    correctHistorianLogAnswer: 1,
    explanation: 'Correct. The river clue was broad, but the planned streets, drains, seals, and weights point much more clearly to the Indus Valley Civilisation.',
    comparisonTags: ['trade', 'administration', 'records'],
  },
  {
    id: 'bureau_3',
    civilisation: 'Ancient Greece',
    caseTitle: 'The Assembly Clue',
    dateRange: '800 BC - 146 BC',
    tier1SiteClue: 'This civilisation grew around the Mediterranean Sea.',
    tier2SocietyClue: 'It had city-states such as Athens and Sparta.',
    tier3LegacyClue: 'It left behind ideas about democracy, philosophy, the Parthenon, and stories about Alexander the Great.',
    civilisationOptions: [
      'Ancient Greece',
      'Ancient Rome',
      'Byzantine Empire',
    ...
    historianLogQuestion: 'Which clue was the strongest evidence?',
    historianLogOptions: [
      'The Mediterranean clue was useful, but it could fit more than one civilisation.',
      'City-states, democracy, philosophy, and the Parthenon were stronger clues.',
      'The mountains and seas were helpful, but not enough by themselves.',
      'The date helped, but it was not the clearest clue.',
    ],
    correctHistorianLogAnswer: 1,
    explanation: 'Correct. The city-states and ideas like democracy and philosophy point much more clearly to Ancient Greece.',
    comparisonTags: ['law', 'administration', 'records'],
  },
  {
    id: 'bureau_4',
    civilisation: 'Ancient Rome',
    caseTitle: 'The Road Clue',
    dateRange: '753 BC - 476 AD',
    tier1SiteClue: 'This civilisation began in the city of Rome and grew around the Mediterranean.',
    tier2SocietyClue: 'It had a republic, senators, emperors, and a powerful army.',
    tier3LegacyClue: 'It left behind roads, aqueducts, laws, Latin, and the Colosseum.',
    civilisationOptions: [
      'Ancient Rome',
      'Ancient Greece',
      'Byzantine Empire',
    ...
    historianLogQuestion: 'Which clue was the strongest evidence?',
    historianLogOptions: [
      'The Mediterranean clue was broad and could fit other civilisations too.',
      'The roads, aqueducts, laws, Latin, and Colosseum pointed clearly to Ancient Rome.',
      'The trade clue was interesting, but it did not prove the answer.',
      'The date helped, but it was not the clearest clue.',
    ],
    correctHistorianLogAnswer: 1,
    explanation: 'Correct. The roads, aqueducts, laws, Latin, and the Colosseum point much more clearly to Ancient Rome.',
    comparisonTags: ['trade', 'administration', 'records'],
  },
  {
    id: 'bureau_5',
    civilisation: 'Ancient China',
    caseTitle: 'The Writing Clue',
    dateRange: '1600 BC - 220 AD',
    tier1SiteClue: 'This civilisation began near the Yellow River.',
    tier2SocietyClue: 'It was ruled by dynasties, or ruling families.',
    tier3LegacyClue: 'It left behind the Great Wall, early writing, paper, silk, and inventions.',
    civilisationOptions: [
      'Ancient China',
      'Mayan Civilisation',
      'Ancient Egypt',
    ...
    historianLogQuestion: 'Which clue was the strongest evidence?',
    historianLogOptions: [
      'The river clue was broad and could fit several civilisations.',
      'Dynasties, early writing, paper, silk, and the Great Wall pointed clearly to Ancient China.',
      'The wall was useful, but by itself it was not enough.',
      'The date helped, but it was not the clearest clue.',
    ],
    correctHistorianLogAnswer: 1,
    explanation: 'Correct. The Yellow River clue helped, but dynasties, writing, paper, silk, and inventions point more clearly to Ancient China.',
    comparisonTags: ['records', 'ritual', 'ancestors'],
  },
  {
    id: 'bureau_6',
    civilisation: 'Mayan Civilisation',
    caseTitle: 'The Glyph Clue',
    dateRange: '2000 BC - 1500 AD',
    tier1SiteClue: 'This civilisation developed in Central America, including the Yucatan Peninsula.',
    tier2SocietyClue: 'It had city-states and local rulers rather than one single empire.',
    tier3LegacyClue: 'It left behind pyramids, calendars, astronomy, maths, and writing.',
    civilisationOptions: [
      'Mayan Civilisation',
      'Ancient China',
      'Aztec Empire',
    ...
    historianLogQuestion: 'Which clue was the strongest evidence?',
    historianLogOptions: [
      'The Mesoamerica clue was useful, but it could fit more than one civilisation.',
      'The pyramids, calendars, astronomy, maths, and writing pointed clearly to the Mayan Civilisation.',
      'The temple clue was interesting, but it was not enough by itself.',
      'The date helped, but it was not the clearest clue.',
    ],
    correctHistorianLogAnswer: 1,
    explanation: 'Correct. The city-states and the mix of pyramids, calendars, astronomy, maths, and writing point clearly to the Mayan Civilisation.',
    comparisonTags: ['records', 'ritual', 'calendar'],
  },
  {
    id: 'bureau_7',
    civilisation: 'Babylonian Empire',
    caseTitle: 'The Law Clue',
    dateRange: '1894 BC - 539 BC',
    tier1SiteClue: 'This civilisation was in Mesopotamia, between the Tigris and Euphrates Rivers.',
    tier2SocietyClue: 'Its rulers used laws, scribes, temples, trade, and records to manage city life.',
    tier3LegacyClue: 'It is linked to cuneiform tablets, the Code of Hammurabi, and the city of Babylon.',
    civilisationOptions: [
      'Babylonian Empire',
      'Persian Empire',
      'Ancient Rome',
    ...
    historianLogQuestion: 'Which clue was the strongest evidence?',
    historianLogOptions: [
      'The Mesopotamian rivers were broad and could fit several societies.',
      'Cuneiform tablets, the law code, scribes, and Babylon pointed clearly to the Babylonian Empire.',
      'The trade clue was useful, but many civilisations traded.',
      'The date helped, but it was not the clearest clue.',
    ],
    correctHistorianLogAnswer: 1,
    explanation: 'Correct. The strongest clue was the law code, cuneiform, scribes, and Babylon.',
    comparisonTags: ['administration', 'records', 'trade'],
  },
  {
    id: 'bureau_8',
    civilisation: 'Persian Empire',
    caseTitle: 'The Royal Road Clue',
    dateRange: '550 BC - 330 BC',
    tier1SiteClue: 'This empire controlled a very large area across western Asia.',
    ...
    historianLogQuestion: 'Which clue was the strongest evidence?',
    historianLogOptions: [
      'A large empire was broad evidence and could fit other empires too.',
      'The Royal Road, satraps, messengers, Cyrus, and Darius pointed clearly to the Persian Empire.',
      'The road clue was useful, but roads alone did not prove the answer.',
      'The date helped, but it was not the clearest clue.',
    ],
    correctHistorianLogAnswer: 1,
    explanation: 'Correct. The Royal Road and the system of satraps point much more clearly to the Persian Empire.',
    comparisonTags: ['administration', 'records', 'trade'],
  },
  {
    id: 'bureau_9',
    civilisation: 'Byzantine Empire',
    caseTitle: 'The Constantinople Clue',
    dateRange: '330 AD - 1453 AD',
    tier1SiteClue: 'This empire centred on a powerful city linking Europe and Asia.',
    tier2SocietyClue: 'Christianity, emperors, Greek language, and church power shaped society.',
    tier3LegacyClue: 'It is linked to Constantinople, Hagia Sophia, mosaics, and Roman traditions.',
    civilisationOptions: [
      'Byzantine Empire',
      'Ancient Rome',
      'Ottoman Empire',
    ...
    historianLogQuestion: 'Which clue was the strongest evidence?',
    historianLogOptions: [
      'A powerful city was useful, but it could fit other empires.',
      'Constantinople, Hagia Sophia, mosaics, and Roman traditions pointed clearly to the Byzantine Empire.',
      'The trade clue was interesting, but it did not identify the civilisation alone.',
      'The date helped, but it was not the clearest clue.',
    ],
    correctHistorianLogAnswer: 1,
    explanation: 'Correct. Constantinople, Hagia Sophia, mosaics, and Roman traditions point much more clearly to the Byzantine Empire.',
    comparisonTags: ['trade', 'administration', 'records'],
  },
  {
    id: 'bureau_10',
    civilisation: 'Ottoman Empire',
    caseTitle: 'The Istanbul Clue',
    dateRange: '1299 AD - 1922 AD',
    tier1SiteClue: 'This empire controlled major trade routes between Europe, Asia, and Africa.',
    tier2SocietyClue: 'Sultans, soldiers, officials, taxes, mosques, and different peoples shaped society.',
    tier3LegacyClue: 'It is linked to the capture of Constantinople, Istanbul, Ottoman sultans, and large mosques.',
    civilisationOptions: [
      'Ottoman Empire',
      'Byzantine Empire',
      'Ancient Rome',
    ...
    historianLogQuestion: 'Which clue was the strongest evidence?',
    historianLogOptions: [
      'Trade routes were useful, but they were too broad on their own.',
      'Sultans, Istanbul, mosques, and the capture of Constantinople pointed clearly to the Ottoman Empire.',
      'The market clue was interesting, but many civilisations had markets.',
      'The date helped, but it was not the clearest clue.',
    ],
    correctHistorianLogAnswer: 1,
    explanation: 'Correct. Sultans, Istanbul, mosques, and Constantinople point much more clearly to the Ottoman Empire.',
    comparisonTags: ['trade', 'administration', 'records'],
  },
  {
    id: 'bureau_11',
    civilisation: 'Inca Empire',
    caseTitle: 'The Andes Clue',
    dateRange: '1438 AD - 1533 AD',
    tier1SiteClue: 'This empire developed in the Andes, where mountains shaped farming and travel.',
    tier2SocietyClue: 'Rulers organised labour, roads, storehouses, terrace farming, and messengers across difficult terrain.',
    tier3LegacyClue: 'It is linked to quipu records, Machu Picchu, Andean roads, and Spanish arrival.',
    civilisationOptions: [
      'Inca Empire',
      'Aztec Empire',
      'Mayan Civilisation',
    ...
    historianLogQuestion: 'Which clue was the strongest evidence?',
    historianLogOptions: [
      'The mountain clue was useful, but it did not identify the civilisation by itself.',
      'Quipu, terrace farming, Andean roads, storehouses, and Machu Picchu pointed clearly to the Inca Empire.',
      'The road clue was interesting, but several empires used roads.',
      'The date helped, but it was not the clearest clue.',
    ],
    correctHistorianLogAnswer: 1,
    explanation: 'Correct. Quipu, terrace farming, Andean roads, storehouses, and Machu Picchu point much more clearly to the Inca Empire.',
    comparisonTags: ['administration', 'records', 'tribute'],
  },
  {
    id: 'bureau_12',
    civilisation: 'Aztec Empire',
    caseTitle: 'The Lake City Clue',
    dateRange: '1428 AD - 1521 AD',
    tier1SiteClue: 'This empire developed in Mesoamerica and built a powerful city in a lake environment.',
    tier2SocietyClue: 'Tribute, warriors, temples, religion, markets, and rulers helped organise empire life.',
    tier3LegacyClue: 'It is linked to Tenochtitlan, chinampas, tribute codices, and Spanish arrival.',
    civilisationOptions: [
      'Aztec Empire',
      'Inca Empire',
      'Mayan Civilisation',
    ...
    historianLogQuestion: 'Which clue was the strongest evidence?',
    historianLogOptions: [
      'The Mesoamerica clue was useful, but it could fit the Mayan Civilisation too.',
      'Tenochtitlan, chinampas, tribute codices, and Spanish arrival pointed clearly to the Aztec Empire.',
      'The market clue was useful, but many civilisations had markets.',
      'The date helped, but it was not the clearest clue.',
    ],
    correctHistorianLogAnswer: 1,
