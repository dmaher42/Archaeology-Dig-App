...
const BUREAU_CASES_RAW = [
  {
    ...
    caseTitle: 'The River Ledger',
    tier1SiteClue: 'Clay sealings and broken jar tops were found in a riverside store room.',
    tier2SocietyClue: 'Papyrus notes list grain, dates, and boat deliveries.',
    tier3LegacyClue: 'Later scribes copied this style of record keeping.',
    civilisationOptions: [
      'Ancient Egypt',
    ...
    historianLogQuestion: 'Which log entry best matches the evidence?',
    historianLogOptions: [
      'The clues show goods being counted and written down.',
      'The clues prove the room was a palace bedroom.',
      'The clues show the jars were only for cooking.',
      'The clues show nobody kept records.',
    ],
    correctHistorianLogAnswer: 0,
    explanation: 'Sealings and papyrus records point to trade, counting, and organised record keeping.',
    comparisonTags: ['trade', 'records', 'river'],
  },
  {
    id: 'bureau_2',
    civilisation: 'Indus Valley Civilisation',
    caseTitle: 'The Sealed Market Street',
    tier1SiteClue: 'A planned city block has a drain and a small stone seal.',
    tier2SocietyClue: 'Standard weights and stamped goods show careful measuring.',
    tier3LegacyClue: 'Later towns copied straight streets and drains.',
    civilisationOptions: [
      'Indus Valley Civilisation',
      'Ancient Egypt',
      'Ancient China',
    ...
    historianLogQuestion: 'Which log entry best matches the evidence?',
    historianLogOptions: [
      'The street shows planning, trade, and shared standards.',
      'The street proves nobody lived in cities.',
      'The street only tells us about hunting.',
      'The street shows the site was just a farm field.',
    ],
    correctHistorianLogAnswer: 0,
    explanation: 'The drain, seal, and weights point to city planning, trade, and measurement.',
    comparisonTags: ['trade', 'administration', 'records'],
  },
  {
    id: 'bureau_3',
    civilisation: 'Ancient Greece',
    caseTitle: 'The Civic Decree',
    tier1SiteClue: 'A stone decree stands in a public square near the assembly.',
    tier2SocietyClue: 'The words list a law, a vote, and citizen duties.',
    tier3LegacyClue: 'Later cities copied public inscriptions for rules and honours.',
    civilisationOptions: [
      'Ancient Greece',
      'Ancient Rome',
      'Byzantine Empire',
    ...
    historianLogQuestion: 'Which log entry best matches the evidence?',
    historianLogOptions: [
      'The inscription shows laws, votes, and public decision making.',
      'The inscription proves the square was a farm.',
      'The inscription tells us the people never wrote anything down.',
      'The inscription only marks a boundary stone.',
    ],
    correctHistorianLogAnswer: 0,
    explanation: 'The public stone and voting language point to law, citizenship, and civic life.',
    comparisonTags: ['law', 'administration', 'records'],
  },
  {
    id: 'bureau_4',
    civilisation: 'Ancient Rome',
    caseTitle: 'The Harbour Ledger',
    tier1SiteClue: 'A port storeroom contains stamped jars and broken seals.',
    tier2SocietyClue: 'A wax tablet lists deliveries, prices, and workers.',
    tier3LegacyClue: 'The port records helped the city manage sea trade.',
    civilisationOptions: [
      'Ancient Rome',
      'Ancient Greece',
      'Byzantine Empire',
    ...
    historianLogQuestion: 'Which log entry best matches the evidence?',
    historianLogOptions: [
      'The port used writing to organise trade, payments, and workers.',
      'The port was cut off from every other city.',
      'The port only stored water for farm animals.',
      'The port proves trade was not important to Roman life.',
    ],
    correctHistorianLogAnswer: 0,
    explanation: 'The jars, seals, and tablet point to trade networks and organised administration.',
    comparisonTags: ['trade', 'administration', 'records'],
  },
  {
    id: 'bureau_5',
    civilisation: 'Ancient China',
    caseTitle: 'The Oracle Bone Query',
    tier1SiteClue: 'A turtle shell with carved signs was found in a royal pit.',
    tier2SocietyClue: 'The questions ask about rain, crops, and ancestors.',
    tier3LegacyClue: 'Later scholars studied the signs as early writing.',
    civilisationOptions: [
      'Ancient China',
      'Maya Civilisation',
      'Ancient Egypt',
    ...
    historianLogQuestion: 'Which log entry best matches the evidence?',
    historianLogOptions: [
      'The shell shows writing linked to belief and decision making.',
      'The shell proves the pit was a market stall.',
      'The shell tells us the people had no religion.',
      'The shell only shows a broken dinner plate.',
    ],
    correctHistorianLogAnswer: 0,
    explanation: 'Oracle bones point to early writing used for questions, beliefs, and planning.',
    comparisonTags: ['records', 'ritual', 'ancestors'],
  },
  {
    id: 'bureau_6',
    civilisation: 'Maya Civilisation',
    caseTitle: 'The Stone Glyph Page',
    tier1SiteClue: 'A carved stair stone holds glyphs and a date sign.',
    tier2SocietyClue: 'The text names rulers, battles, and ceremony days.',
    tier3LegacyClue: 'Descendants still study some of the symbols today.',
    civilisationOptions: [
      'Maya Civilisation',
      'Ancient China',
      'Aztec Empire',
    ...
    historianLogQuestion: 'Which log entry best matches the evidence?',
    historianLogOptions: [
      'The glyphs show writing used for rulers, events, and ceremony.',
      'The glyphs prove the stone came from a beach.',
      'The glyphs tell us people could not read numbers.',
      'The glyphs only show decoration with no meaning.',
    ],
    correctHistorianLogAnswer: 0,
    explanation: 'The glyphs and date sign point to writing, rulership, and calendar knowledge.',
    comparisonTags: ['records', 'ritual', 'calendar'],
  },
  {
    id: 'bureau_7',
    civilisation: 'Babylonian Empire',
    caseTitle: 'The Clay Contract',
    tier1SiteClue: 'A clay tablet in a temple archive carries a seal.',
    tier2SocietyClue: 'The lines list barley, wages, and a worker name.',
    tier3LegacyClue: 'Later officials used similar tablets to manage cities.',
    civilisationOptions: [
      'Babylonian Empire',
      'Persian Empire',
      'Ancient Rome',
    ...
    historianLogQuestion: 'Which log entry best matches the evidence?',
    historianLogOptions: [
      'The tablet shows records for work, wages, and goods.',
      'The tablet proves the temple was empty.',
      'The tablet tells us nobody used numbers.',
      'The tablet only shows a farming tool list.',
    ],
    correctHistorianLogAnswer: 0,
    explanation: 'The clay tablet points to writing, records, and organised management.',
    comparisonTags: ['administration', 'records', 'trade'],
  },
  {
    id: 'bureau_8',
    civilisation: 'Persian Empire',
    caseTitle: 'The Royal Road Message',
    tier1SiteClue: 'A roadside station keeps stamped clay notes and travel lists.',
    tier2SocietyClue: 'The notes list horses, supplies, and guard checks.',
    tier3LegacyClue: 'The road linked many lands under one empire.',
    civilisationOptions: [
      'Persian Empire',
      'Babylonian Empire',
      'Ancient Rome',
    ...
    historianLogQuestion: 'Which log entry best matches the evidence?',
    historianLogOptions: [
      'The road system shows administration, travel, and control.',
      'The road system proves the empire had no workers.',
      'The road system tells us people never moved goods.',
      'The road system only shows where animals slept.',
    ],
    correctHistorianLogAnswer: 0,
    explanation: 'The clues point to long-distance control, travel, and record keeping.',
    comparisonTags: ['administration', 'records', 'trade'],
  },
  {
    id: 'bureau_9',
    civilisation: 'Byzantine Empire',
    caseTitle: 'The Church Donation Roll',
    tier1SiteClue: 'A church store room keeps a wax seal and a copied list.',
    tier2SocietyClue: 'The list records land gifts, grain, and clergy names.',
    tier3LegacyClue: 'The records helped manage church wealth for years.',
    civilisationOptions: [
      'Byzantine Empire',
      'Ancient Rome',
      'Ottoman Empire',
    ...
    historianLogQuestion: 'Which log entry best matches the evidence?',
    historianLogOptions: [
      'The list shows administration, gifts, and record keeping.',
      'The list proves the church had no land.',
      'The list tells us the building was a schoolyard.',
      'The list only shows a list of songs.',
    ],
    correctHistorianLogAnswer: 0,
    explanation: 'The donation roll points to church administration and written records.',
    comparisonTags: ['trade', 'administration', 'records'],
  },
  {
    id: 'bureau_10',
    civilisation: 'Ottoman Empire',
    caseTitle: 'The Bazaar Register',
    tier1SiteClue: 'A market office keeps sealed books with shop names.',
    tier2SocietyClue: 'The pages list taxes, goods, and trade routes.',
    tier3LegacyClue: 'City officers used the register to manage the market.',
    civilisationOptions: [
      'Ottoman Empire',
      'Byzantine Empire',
      'Ancient Rome',
    ...
    historianLogQuestion: 'Which log entry best matches the evidence?',
    historianLogOptions: [
      'The register shows trade, taxes, and city management.',
      'The register proves the market was empty every day.',
      'The register tells us there were no shops.',
      'The register only shows weather notes.',
    ],
    correctHistorianLogAnswer: 0,
    explanation: 'The register points to trade, taxes, and organised market control.',
    comparisonTags: ['trade', 'administration', 'records'],
  },
  {
    id: 'bureau_11',
    civilisation: 'Inca Empire',
    caseTitle: 'The Quipu Storehouse',
    tier1SiteClue: 'A storehouse holds knotted cords tied to shelves of maize.',
    tier2SocietyClue: 'Keepers count workers, food, and goods with knots.',
    tier3LegacyClue: 'Later communities studied quipu as record keeping evidence.',
    civilisationOptions: [
      'Inca Empire',
      'Aztec Empire',
      'Maya Civilisation',
    ...
    historianLogQuestion: 'Which log entry best matches the evidence?',
    historianLogOptions: [
      'The quipu shows record keeping and administration.',
      'The quipu proves the storehouse was a temple gate.',
      'The quipu tells us nobody counted food.',
      'The quipu only shows rope made for play.',
    ],
    correctHistorianLogAnswer: 0,
    explanation: 'The knotted cords point to counting, record keeping, and state management.',
    comparisonTags: ['administration', 'records', 'tribute'],
  },
  {
    id: 'bureau_12',
    civilisation: 'Aztec Empire',
    caseTitle: 'The Tribute Codex',
    tier1SiteClue: 'A painted book from a palace archive shows bundles of maize and cloth.',
    tier2SocietyClue: 'The pages list tribute from towns and the officials who collected it.',
    tier3LegacyClue: 'Later historians used the codex to study empire and tribute.',
    civilisationOptions: [
      'Aztec Empire',
      'Inca Empire',
      'Maya Civilisation',
    ...
    historianLogQuestion: 'Which log entry best matches the evidence?',
    historianLogOptions: [
      'The codex shows administration, tribute, and records.',
      'The codex proves the palace was a farm shed.',
      'The codex tells us the empire did not collect goods.',
      'The codex only shows a picture book for children.',
    ],
    correctHistorianLogAnswer: 0,
    explanation: 'The painted book points to tribute, administration, and written record keeping.',
    comparisonTags: ['administration', 'records', 'tribute'],
  },
];
...
export const BUREAU_COMPARISON_CHALLENGES = [
  {
    ...
    question: 'What shared theme fits these two cases best?',
    options: [
      'Both show river-valley societies using records, trade, and planning.',
      'Both show the same burial customs.',
      'Both were built with modern machines.',
      'Both avoided writing and measurement.',
    ],
    correctAnswer: 0,
    explanation: 'Both cases use seals, records, and planning to show organised river-valley life.',
  },
  {
    ...
    question: 'What shared theme fits these two cases best?',
    options: [
      'Both show law, public writing, and civic administration.',
      'Both show the same river farming system.',
      'Both avoided public writing.',
      'Both were isolated from later history.',
    ],
    correctAnswer: 0,
    explanation: 'Both cases use public inscriptions and records to show organised city life.',
  },
  {
    civilisations: ['Ancient China', 'Maya Civilisation'],
    title: 'Ancient China + Maya Civilisation',
    question: 'What shared theme fits these two cases best?',
    options: [
      'Both show writing linked to rulers, ritual, and timekeeping.',
      'Both show desert trade only.',
      'Both had no interest in calendars.',
      'Both relied on metal coins.',
    ],
    correctAnswer: 0,
    explanation: 'Both cases show writing being used for rulers, beliefs, and calendar knowledge.',
  },
  {
    ...
    question: 'What shared theme fits these two cases best?',
    options: [
      'Both show administration, records, and control across distance.',
      'Both were small village communities.',
      'Both had no records.',
      'Both relied only on fishing.',
    ],
    correctAnswer: 0,
    explanation: 'Both cases show rulers using records and officials to manage large empires.',
  },
  {
    ...
    question: 'What shared theme fits these two cases best?',
    options: [
      'Both show city trade and administration in the same region.',
      'Both show the same tomb rituals.',
      'Both avoided city life.',
      'Both had no links to government.',
    ],
    correctAnswer: 0,
    explanation: 'Both cases show markets, officials, and records used to manage a major city.',
  },
  {
    ...
    question: 'What shared theme fits these two cases best?',
    options: [
      'Both show empire control through records and tribute.',
      'Both show the same ocean trade routes.',
      'Both were modern industrial states.',
      'Both had no state control.',
    ],
    correctAnswer: 0,
    explanation: 'Both cases show how rulers used records and tribute to manage empire life.',
  },
];
...
export const BUREAU_RESEARCH_FOCUS = {
  ...
  'Maya Civilisation': {
    ...
    inquiryQuestion: 'How did writing, calendars, and cities shape Maya civilisation?',
    evidenceReminder: 'Look for evidence that shows how the Maya recorded time, rulers, and ceremony.',
  },
  'Persian Empire': {
