...
const BUREAU_CASES_RAW = [
  {
    ...
    caseTitle: 'The Nile Tomb Record',
    dateRange: '3150 BC - 30 BC',
    tier1SiteClue: 'This civilisation developed beside a major river where predictable flooding supported farming and surplus food.',
    tier2SocietyClue: 'Its rulers held both political and religious power and were linked to the gods.',
    tier3LegacyClue: 'It built pyramids as tombs and used hieroglyphic writing to record beliefs and events.',
    civilisationOptions: [
      'Ancient Egypt',
    ...
    historianLogQuestion: 'Which evidence most strongly supports the claim that this case file belongs to Ancient Egypt?',
    historianLogOptions: [
      'A river and farming are useful clues, but they could fit several early civilisations.',
      'The combination of Pharaohs, pyramids, and hieroglyphics is highly specific to Ancient Egypt.',
      'The evidence is interesting, but farming alone is not enough to confirm the claim.',
      'The evidence does not match a civilisation with rulers, tombs, and writing.',
    ],
    correctHistorianLogAnswer: 1,
    explanation: 'Claim supported. The Nile is useful site evidence, but Pharaohs, pyramids, and hieroglyphics provide stronger identifying evidence.',
    comparisonTags: ['trade', 'records', 'river'],
  },
  {
    id: 'bureau_2',
    civilisation: 'Indus Valley Civilisation',
    caseTitle: 'The Sealed Street Grid',
    dateRange: '2600 BC - 1900 BC',
    tier1SiteClue: 'This civilisation grew near river systems where farming and trade could support large settlements.',
    tier2SocietyClue: 'Its cities show planned streets, drains, wells, and carefully organised neighbourhoods.',
    tier3LegacyClue: 'Small seals, standard weights, and undeciphered writing suggest trade and record keeping.',
    civilisationOptions: [
      'Indus Valley Civilisation',
      'Ancient Egypt',
      'Ancient China',
    ...
    correctCivilisation: 0,
    historianLogQuestion: 'Which evidence most strongly supports the claim that this case file belongs to the Indus Valley Civilisation?',
    historianLogOptions: [
      'River farming is broad evidence and could fit several early civilisations.',
      'Planned streets, drainage, seals, and standard weights strongly match Indus Valley cities.',
      'A single seal is useful, but by itself it does not explain the whole society.',
      'The evidence does not fit a civilisation known for careful city planning.',
    ],
    correctHistorianLogAnswer: 1,
    explanation: 'Claim supported. The river clue is broad, but the drains, planned streets, seals, and weights make the identification much stronger.',
    comparisonTags: ['trade', 'administration', 'records'],
  },
  {
    id: 'bureau_3',
    civilisation: 'Ancient Greece',
    caseTitle: 'The Assembly Stone',
    dateRange: '800 BC - 146 BC',
    tier1SiteClue: 'This civilisation developed around the Mediterranean, where mountains and seas shaped separate communities.',
    tier2SocietyClue: 'Many communities were city-states, and some citizens met to debate laws and decisions.',
    tier3LegacyClue: 'Its legacy includes democracy, philosophy, theatre, temples, and public inscriptions.',
    civilisationOptions: [
      'Ancient Greece',
      'Ancient Rome',
      'Byzantine Empire',
    ...
    correctCivilisation: 0,
    historianLogQuestion: 'Which evidence most strongly supports the claim that this case file belongs to Ancient Greece?',
    historianLogOptions: [
      'A Mediterranean location is useful, but it could also fit Rome or later empires.',
      'City-states, citizen debate, democracy, theatre, and philosophy strongly support Ancient Greece.',
      'Mountains and seas are important context, but they do not identify the civilisation alone.',
      'The evidence does not match a civilisation known for public debate and city-states.',
    ],
    correctHistorianLogAnswer: 1,
    explanation: 'Claim supported. Geography gives a starting point, but city-states, citizen debate, democracy, and philosophy are stronger identifying evidence.',
    comparisonTags: ['law', 'administration', 'records'],
  },
  {
    id: 'bureau_4',
    civilisation: 'Ancient Rome',
    caseTitle: 'The Road and Forum File',
    dateRange: '753 BC - 476 AD',
    tier1SiteClue: 'This civilisation began in the Mediterranean and expanded through conquest, trade, and roads.',
    tier2SocietyClue: 'Its society used laws, citizenship, public buildings, and powerful leaders to govern people.',
    tier3LegacyClue: 'Its roads, aqueducts, Latin language, republican ideas, and imperial rule influenced later societies.',
    civilisationOptions: [
      'Ancient Rome',
      'Ancient Greece',
      'Byzantine Empire',
    ...
    correctCivilisation: 0,
    historianLogQuestion: 'Which evidence most strongly supports the claim that this case file belongs to Ancient Rome?',
    historianLogOptions: [
      'Mediterranean expansion is useful, but it is too broad by itself.',
      'Roads, aqueducts, Latin, laws, citizenship, and imperial rule strongly identify Ancient Rome.',
      'Trade is interesting evidence, but it does not separate Rome from other empires alone.',
      'The evidence does not fit a society known for roads, law, and empire.',
    ],
    correctHistorianLogAnswer: 1,
    explanation: 'Claim supported. The strongest evidence is the combination of roads, aqueducts, law, citizenship, Latin, and empire.',
    comparisonTags: ['trade', 'administration', 'records'],
  },
  {
    id: 'bureau_5',
    civilisation: 'Ancient China',
    caseTitle: 'The Oracle Bone Record',
    dateRange: '1600 BC - 220 AD',
    tier1SiteClue: 'This civilisation developed in river valleys where farming, flooding, and settlement supported larger communities.',
    tier2SocietyClue: 'Dynasties, ancestor beliefs, and rulers helped organise society and power.',
    tier3LegacyClue: 'Oracle bones, early Chinese writing, silk, inventions, and later walls became major parts of its legacy.',
    civilisationOptions: [
      'Ancient China',
      'Mayan Civilisation',
      'Ancient Egypt',
    ...
    correctCivilisation: 0,
    historianLogQuestion: 'Which evidence most strongly supports the claim that this case file belongs to Ancient China?',
    historianLogOptions: [
      'River valley farming is broad evidence and could fit Egypt, Indus, or Babylon too.',
      'Dynasties, ancestor beliefs, oracle bones, early Chinese writing, and silk strongly support Ancient China.',
      'A wall is useful evidence, but by itself it does not explain the whole case file.',
      'The evidence does not match a civilisation with dynasties and oracle bones.',
    ],
    correctHistorianLogAnswer: 1,
    explanation: 'Claim supported. The broad river clue needed stronger evidence, and oracle bones with dynasties and early Chinese writing provide it.',
    comparisonTags: ['records', 'ritual', 'ancestors'],
  },
  {
    id: 'bureau_6',
    civilisation: 'Mayan Civilisation',
    caseTitle: 'The Glyph Staircase',
    dateRange: '2000 BC - 1500 AD',
    tier1SiteClue: 'This civilisation developed in Mesoamerica, where forests, farming, and city centres shaped daily life.',
    tier2SocietyClue: 'Its city-states had rulers, temples, ceremonies, and records carved into stone.',
    tier3LegacyClue: 'Glyph writing, calendars, astronomy, stepped temples, and recorded rulers identify the case file.',
    civilisationOptions: [
      'Mayan Civilisation',
      'Ancient China',
      'Aztec Empire',
    ...
    correctCivilisation: 0,
    historianLogQuestion: 'Which evidence most strongly supports the claim that this case file belongs to the Mayan Civilisation?',
    historianLogOptions: [
      'Mesoamerica is useful, but it could fit more than one civilisation.',
      'Glyph writing, calendars, astronomy, temples, and recorded rulers strongly support the Mayan Civilisation.',
      'Temples are useful evidence, but many civilisations built temples.',
      'The evidence does not fit a civilisation known for glyphs and calendars.',
    ],
    correctHistorianLogAnswer: 1,
    explanation: 'Claim supported. The strongest evidence is the specific mix of glyphs, calendars, astronomy, temples, and city-state rulers.',
    comparisonTags: ['records', 'ritual', 'calendar'],
  },
  {
    id: 'bureau_7',
    civilisation: 'Babylonian Empire',
    caseTitle: 'The Clay Law Tablet',
    dateRange: '1894 BC - 539 BC',
    tier1SiteClue: 'This civilisation developed in Mesopotamia between major rivers where farming and cities grew.',
    tier2SocietyClue: 'Its rulers used laws, scribes, temples, trade, and records to manage city life.',
    tier3LegacyClue: 'Cuneiform tablets, the Code of Hammurabi, and Babylonian city power identify the case file.',
    civilisationOptions: [
      'Babylonian Empire',
      'Persian Empire',
      'Ancient Rome',
    ...
    correctCivilisation: 0,
    historianLogQuestion: 'Which evidence most strongly supports the claim that this case file belongs to the Babylonian Empire?',
    historianLogOptions: [
      'Mesopotamian rivers are broad evidence and could fit several societies.',
      'Cuneiform tablets, law codes, scribes, and Babylonian city power strongly identify the Babylonian Empire.',
      'Trade is useful evidence, but many civilisations traded.',
      'The evidence does not match a society known for cuneiform and law codes.',
    ],
    correctHistorianLogAnswer: 1,
    explanation: 'Claim supported. The strongest evidence is the specific link between cuneiform, law codes, scribes, and Babylon.',
    comparisonTags: ['administration', 'records', 'trade'],
  },
  {
    id: 'bureau_8',
    civilisation: 'Persian Empire',
    caseTitle: 'The Royal Road Dispatch',
    dateRange: '550 BC - 330 BC',
    tier1SiteClue: 'This civilisation controlled a very large area across western Asia and connected many peoples.',
    tier2SocietyClue: 'Satraps, messengers, roads, taxes, and tolerance helped rulers control distant regions.',
    tier3LegacyClue: 'The Royal Road, imperial administration, and kings such as Cyrus and Darius identify the case file.',
    civilisationOptions: [
      'Persian Empire',
      'Babylonian Empire',
      'Ancient Rome',
    ...
    correctCivilisation: 0,
    historianLogQuestion: 'Which evidence most strongly supports the claim that this case file belongs to the Persian Empire?',
    historianLogOptions: [
      'A large empire is broad evidence and could fit Rome or the Ottomans too.',
      'Satraps, the Royal Road, messengers, Cyrus, and Darius strongly support the Persian Empire.',
      'Roads are useful evidence, but roads alone do not prove the claim.',
      'The evidence does not match an empire organised through satraps and royal roads.',
    ],
    correctHistorianLogAnswer: 1,
    explanation: 'Claim supported. The strongest evidence is the Royal Road with satraps, messengers, and Persian rulers.',
    comparisonTags: ['administration', 'records', 'trade'],
  },
  {
    id: 'bureau_9',
    civilisation: 'Byzantine Empire',
    caseTitle: 'The Constantinople Mosaic',
    dateRange: '330 AD - 1453 AD',
    tier1SiteClue: 'This civilisation centred on a powerful city linking Europe and Asia through trade and defence.',
    tier2SocietyClue: 'Christianity, emperors, Greek language, and church power shaped society.',
    tier3LegacyClue: 'Constantinople, Hagia Sophia, mosaics, and the continuation of Roman traditions identify the case file.',
    civilisationOptions: [
      'Byzantine Empire',
      'Ancient Rome',
      'Ottoman Empire',
    ...
    correctCivilisation: 0,
    historianLogQuestion: 'Which evidence most strongly supports the claim that this case file belongs to the Byzantine Empire?',
    historianLogOptions: [
      'A powerful trading city is useful, but it could fit other empires.',
      'Constantinople, Christianity, Hagia Sophia, mosaics, and Roman continuity strongly support the Byzantine Empire.',
      'Trade is important evidence, but it does not identify the civilisation alone.',
      'The evidence does not match an empire centred on Constantinople and Christian imperial power.',
    ],
    correctHistorianLogAnswer: 1,
    explanation: 'Claim supported. The strongest evidence is the combination of Constantinople, Christianity, Hagia Sophia, mosaics, and Roman continuity.',
    comparisonTags: ['trade', 'administration', 'records'],
  },
  {
    id: 'bureau_10',
    civilisation: 'Ottoman Empire',
    caseTitle: 'The Istanbul Bazaar Register',
    dateRange: '1299 AD - 1922 AD',
    tier1SiteClue: 'This civilisation controlled major trade routes between Europe, Asia, and Africa.',
    tier2SocietyClue: 'Sultans, soldiers, officials, taxes, mosques, and diverse peoples shaped society.',
    tier3LegacyClue: 'The capture of Constantinople, Istanbul, Ottoman sultans, and large mosques identify the case file.',
    civilisationOptions: [
      'Ottoman Empire',
      'Byzantine Empire',
      'Ancient Rome',
    ...
    correctCivilisation: 0,
    historianLogQuestion: 'Which evidence most strongly supports the claim that this case file belongs to the Ottoman Empire?',
    historianLogOptions: [
      'Trade routes are useful but too broad to confirm the claim alone.',
      'Sultans, Istanbul, mosques, taxes, and the capture of Constantinople strongly support the Ottoman Empire.',
      'Markets are interesting evidence, but many civilisations had markets.',
      'The evidence does not match a civilisation ruled by sultans from Istanbul.',
    ],
    correctHistorianLogAnswer: 1,
    explanation: 'Claim supported. The strongest evidence is the specific link between sultans, Istanbul, mosques, and control of Constantinople.',
    comparisonTags: ['trade', 'administration', 'records'],
  },
  {
    id: 'bureau_11',
    civilisation: 'Inca Empire',
    caseTitle: 'The Andean Quipu File',
    dateRange: '1438 AD - 1533 AD',
    tier1SiteClue: 'This civilisation developed in the Andes, where mountains required careful farming and transport systems.',
    tier2SocietyClue: 'Rulers organised labour, roads, storehouses, terrace farming, and messengers across difficult terrain.',
    tier3LegacyClue: 'Quipu records, Machu Picchu, Andean roads, and Spanish arrival identify the case file.',
    civilisationOptions: [
      'Inca Empire',
      'Aztec Empire',
      'Mayan Civilisation',
    ...
    correctCivilisation: 0,
    historianLogQuestion: 'Which evidence most strongly supports the claim that this case file belongs to the Inca Empire?',
    historianLogOptions: [
      'Mountains are useful context, but they do not identify the civilisation by themselves.',
      'Quipu, terrace farming, Andean roads, storehouses, and Machu Picchu strongly support the Inca Empire.',
      'Roads are useful evidence, but several empires used roads.',
      'The evidence does not match a civilisation known for quipu and Andean administration.',
    ],
    correctHistorianLogAnswer: 1,
    explanation: 'Claim supported. The strongest evidence is the specific mix of quipu, terrace farming, Andean roads, storehouses, and Machu Picchu.',
    comparisonTags: ['administration', 'records', 'tribute'],
  },
  {
    id: 'bureau_12',
    civilisation: 'Aztec Empire',
    caseTitle: 'The Tenochtitlan Tribute Codex',
    dateRange: '1428 AD - 1521 AD',
    tier1SiteClue: 'This civilisation developed in Mesoamerica and built a powerful city in a lake environment.',
    tier2SocietyClue: 'Tribute, warriors, temples, religion, markets, and rulers helped organise empire life.',
    tier3LegacyClue: 'Tenochtitlan, chinampas, tribute codices, and Spanish arrival identify the case file.',
    civilisationOptions: [
      'Aztec Empire',
      'Inca Empire',
      'Mayan Civilisation',
    ...
    correctCivilisation: 0,
    historianLogQuestion: 'Which evidence most strongly supports the claim that this case file belongs to the Aztec Empire?',
    historianLogOptions: [
      'Mesoamerica is useful, but it could fit the Mayan Civilisation too.',
      'Tenochtitlan, chinampas, tribute codices, temples, and Spanish arrival strongly support the Aztec Empire.',
      'Markets are useful evidence, but many civilisations had markets.',
      'The evidence does not match a lake city using tribute records and chinampas.',
    ],
    correctHistorianLogAnswer: 1,
    explanation: 'Claim supported. The strongest evidence is the specific link between Tenochtitlan, chinampas, tribute codices, temples, and Spanish arrival.',
    comparisonTags: ['administration', 'records', 'tribute'],
  },
];
...
export const BUREAU_CASES = BUREAU_CASES_RAW.map(caseItem => ({
  ...caseItem,
  civilisationOptions: caseItem.civilisationOptions || caseItem.answerOptions || [],
  correctCivilisation: Number.isInteger(caseItem.correctCivilisation)
    ? caseItem.correctCivilisation
    : (Number.isInteger(caseItem.correctAnswer) ? caseItem.correctAnswer : 0),
  answerOptions: caseItem.civilisationOptions || caseItem.answerOptions || [],
  correctAnswer: Number.isInteger(caseItem.correctCivilisation)
    ? caseItem.correctCivilisation
    : (Number.isInteger(caseItem.correctAnswer) ? caseItem.correctAnswer : 0),
}));
...
export const BUREAU_COMPARISON_CHALLENGES = [
  {
    ...
    question: 'Compare the two restored case files. Which pattern appears in both civilisations?',
    options: [
    ...
    correctAnswer: 0,
    explanation: 'Pattern supported. Both case files show river environments helping farming, settlement, and organised communities grow.',
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'Pattern supported. Both case files show public life, government, law, architecture, and legacies that shaped later societies.',
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'Pattern supported. Both case files show that historians use writing, records, beliefs, and knowledge systems to understand societies.',
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'Pattern supported. Both case files show that written records, laws, and officials helped empires control complex societies.',
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'Pattern supported. These case files show continuity and change: the same strategic city mattered to different empires.',
  },
  {
    ...
    correctAnswer: 0,
    explanation: 'Pattern supported. Both case files show complex American empires that organised people, resources, religion, and power before Spanish conquest.',
  },
];
