...
export const BUREAU_CASES = [
  {
    id: 'bureau_1',
    civilisation: 'Ancient Egypt',
    caseTitle: 'The Sealed Tomb Docket',
    tier1SiteClue: 'A sealed tomb chamber with fresh plaster and a painted name over the doorway.',
    tier2SocietyClue: 'Inside are offering bowls and temple notes listing food left for the dead.',
    tier3LegacyClue: 'Generations later, families still visited the tomb to leave flowers and prayers.',
    answerOptions: [
      'This evidence suggests the dead were protected and remembered through ritual care.',
      'This evidence suggests the site was mainly a storehouse for grain.',
      'This evidence suggests people avoided all burial rituals.',
      'This evidence suggests the tomb was built to hide tools from workers.',
    ],
    correctAnswer: 0,
    historianLogQuestion: 'Which log entry would best help a historian explain this case?',
    historianLogOptions: [
      'The tomb shows long-term beliefs about protection, offerings, and life after death.',
      'The tomb proves everyone lived in the same house.',
      'The tomb tells us the people had no religion.',
      'The tomb only shows where farmers kept food.',
    ],
    correctHistorianLogAnswer: 0,
    explanation: 'The clues point to burial rituals, offering practices, and family memory.',
    comparisonTags: ['burial', 'ritual', 'afterlife'],
  },
  {
    id: 'bureau_2',
    civilisation: 'Ancient China',
    caseTitle: 'The Ancestor Record',
    tier1SiteClue: 'A stone pit holds a carefully placed ancestor tablet and bronze offering cup.',
    tier2SocietyClue: 'Clay labels and written notes list gifts given by household members.',
    tier3LegacyClue: 'Later communities copied the rituals to honour ancestors at home shrines.',
    answerOptions: [
      'This evidence suggests ancestor worship helped organise family life and belief.',
      'This evidence suggests the pit was a simple rubbish hole.',
      'This evidence suggests the people were only storing farm tools.',
      'This evidence suggests the tablet was a game piece with no meaning.',
    ],
    correctAnswer: 0,
    historianLogQuestion: 'Which log entry would best help a historian explain this case?',
    historianLogOptions: [
      'The tablet and offerings show respect for ancestors and family ritual.',
      'The tablet proves the site was a market stall.',
      'The tablet tells us nobody in the society wrote anything down.',
      'The tablet only shows where children played.',
    ],
    correctHistorianLogAnswer: 0,
    explanation: 'The clues point to ancestor worship, household ritual, and long-term cultural memory.',
    comparisonTags: ['burial', 'ritual', 'ancestors'],
  },
  {
    id: 'bureau_3',
    ...
    tier2SocietyClue: 'A wax tablet lists deliveries, prices, and the names of workers.',
    tier3LegacyClue: 'The port\'s records helped the city manage trade across the sea.',
    answerOptions: [
      'This evidence suggests trade relied on records and organised administration.',
      'This evidence suggests the harbour was mainly used for royal ceremonies.',
      'This evidence suggests the jars were decorated only for display.',
      'This evidence suggests the city did not use written records at all.',
    ],
    correctAnswer: 0,
    historianLogQuestion: 'Which log entry would best help a historian explain this case?',
    historianLogOptions: [
    ...
    correctHistorianLogAnswer: 0,
    explanation: 'The clues point to trade networks, record-keeping, and organised administration.',
    comparisonTags: ['trade', 'administration', 'records'],
  },
  {
    id: 'bureau_4',
    civilisation: 'Ancient China',
    caseTitle: 'The Bamboo Account',
    tier1SiteClue: 'A dry tomb preserves tied bamboo slips with ink writing.',
    tier2SocietyClue: 'The slips list taxes, rations, and workshop supplies.',
    tier3LegacyClue: 'The writing shows rulers used records to manage people and goods.',
    answerOptions: [
      'This evidence suggests records helped rulers manage daily life and resources.',
      'This evidence suggests the bamboo was only used as firewood.',
      'This evidence suggests the slips were made just for decoration.',
      'This evidence suggests nobody needed to keep track of taxes or supplies.',
    ],
    correctAnswer: 0,
    historianLogQuestion: 'Which log entry would best help a historian explain this case?',
    historianLogOptions: [
      'The bamboo slips show writing used for taxes, supplies, and government control.',
      'The bamboo slips prove the tomb was empty.',
      'The bamboo slips tell us people never counted goods.',
      'The bamboo slips only show a musical performance.',
    ],
    correctHistorianLogAnswer: 0,
    explanation: 'The clues point to writing, administration, and record-keeping across society.',
    comparisonTags: ['trade', 'administration', 'records'],
  },
];
