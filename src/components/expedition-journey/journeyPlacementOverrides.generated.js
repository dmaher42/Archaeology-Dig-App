...
const journeyPlacementOverrides = {
  ...
  "props": [
    ...
    },
    {
      ...
      "brightness": 0.95,
      "colorGradeFilter": "saturate(65%) sepia(56%) contrast(99%) hue-rotate(-23deg)",
      "mirrorX": false,
      "zIndex": 5
    },
    {
    ...
    },
    {
      ...
      "rotation": 10,
      "colorGradeFilter": "sepia(28%) hue-rotate(10deg) saturate(65%) brightness(82%) contrast(110%)",
      "alpha": 1,
      "shadowOpacity": 0.22,
      "shadowWidth": 106,
    ...
    },
    {
      ...
      "mirrorX": true,
      "brightness": 0.9,
      "colorGradeFilter": "saturate(105%) sepia(18%) contrast(126%)",
      "shadowHeight": 9,
      "sandMoundHeight": 0
    },
    {
    ...
    },
    {
      ...
      "scale": 0.65,
      "colorGradeFilter": "saturate(78%) sepia(16%) contrast(90%) hue-rotate(3deg)",
      "brightness": 0.8,
      "zIndex": -43
    },
    {
    ...
    },
    {
      ...
      "groundPebbles": 0,
      "brightness": 1.1,
      "colorGradeFilter": "saturate(96%) sepia(58%) contrast(131%)",
      "groundContactLayer": [
        {
          "assetKey": "premiumRubbleContactShadow",
          "layer": "overlay",
    ...
    },
    {
      ...
      "groundPebbles": 0,
      "brightness": 0.95,
      "colorGradeFilter": "saturate(145%) sepia(17%) contrast(78%) hue-rotate(3deg)",
      "groundContactLayer": [
        {
    ...
    },
    {
      ...
      "groundPebbles": 0,
      "brightness": 1,
      "colorGradeFilter": "saturate(92%) sepia(28%) contrast(90%) hue-rotate(6deg)",
      "groundContactLayer": [
        {
          "assetKey": "premiumRubbleMoundBlend",
          "layer": "overlay",
    ...
    },
    {
      ...
      "depth": "grounded",
      "zIndex": 0,
      "colorGradeFilter": "saturate(133%) sepia(11%) contrast(88%) hue-rotate(5deg)",
      "sandMoundWidth": 0,
      "sandMoundHeight": 0,
      "groundPebbles": 0,
      "sandOverlapHeight": 0,
    ...
    {
      "id": "desert-entry-opening-pyramid-left-stair-face-1",
      "sectionId": "desert-entry",
      "type": "atmosphere-prop",
      "atmosphereAssetKey": "openingPyramidLeftStairFace",
      "width": 430,
      "height": 1472,
      "scale": 0.7,
      "layer": "foreground",
      "depth": "route-edge",
      "tint": "buried-stone",
      "colorGradeFilter": "saturate(70%) sepia(23%) contrast(128%) hue-rotate(-1deg)",
      "alpha": 0.98,
      "shadowOpacity": 0.18,
      "sandOverlapHeight": 7,
      "sandMoundWidth": 360,
      ...
      "x": 823,
      "y": 37,
      "label": "opening pyramid left stair face",
      "zIndex": 0,
      "brightness": 1.15
    },
    {
      ...
      "label": "short sand lip",
      "scale": 0.65,
      "colorGradeFilter": "saturate(90%) sepia(28%) contrast(124%)",
      "brightness": 0.95,
      "zIndex": -43
    },
    {
