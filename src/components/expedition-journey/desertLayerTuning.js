...
export const DESERT_LAYER_TUNING_DEFAULTS = {
  ...
  templeFoundationTransition: { y: 438, height: 154, parallax: 0.72, alpha: 1, brightness: 0.96, saturate: 0.72, contrast: 1.1, shadowLift: 0.04, highlightClamp: 0.9, dustHaze: 0 },
  groundTransition: { y: 523, height: 129, parallax: 1, alpha: 0.76, brightness: 1, saturate: 0.78, contrast: 0.92, shadowLift: 0.05, highlightClamp: 0.94, dustHaze: 0.01 },
  groundLane: { y: 558, height: 174, parallax: 1, alpha: 1, brightness: 1.06, saturate: 0.84, contrast: 1.06, shadowLift: 0.04, highlightClamp: 0.92, dustHaze: 0 },
