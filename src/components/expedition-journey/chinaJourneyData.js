...
export const CHINA_SECTION_ATMOSPHERES = {
  [CHINA_SECTION_IDS.FRONTIER]: {
    ...
    particle:      'river mist',
    particleColor: 'rgba(220, 210, 180, 0.45)',
  ...
  [CHINA_SECTION_IDS.WALL]: {
    ...
    particle:      'construction dust',
    particleColor: 'rgba(214, 190, 150, 0.50)',
  ...
  [CHINA_SECTION_IDS.SETTLEMENT]: {
    ...
    particle:      'kiln smoke',
    particleColor: 'rgba(210, 180, 140, 0.46)',
  ...
  [CHINA_SECTION_IDS.ARCHIVE]: {
    ...
    particle:      'archive dust motes',
    particleColor: 'rgba(170, 200, 180, 0.42)',
  ...
  [CHINA_SECTION_IDS.GATE]: {
    ...
    particle:      'banner ash',
    particleColor: 'rgba(210, 180, 140, 0.40)',
