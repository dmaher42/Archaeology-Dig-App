...
export const ROME_PLATFORMS = [
  ...
  { id: 'forum-podium-step',      x: X(3300), y: JY(200), width: X(250), height: 18, label: 'temple podium step' },
  { id: 'forum-podium-top',       x: X(3480), y: JY(60),  width: X(300), height: 18, label: 'temple podium top' },
...
export const ROME_SHARD_LAYOUT = [
  // Via Sacra
  { id: 'shard-milestone-inscription', x: X(920),  y: JY(260), sectionId: ROME_SECTION_IDS.VIA_SACRA },
  { id: 'shard-cobble-seal',           x: X(1400), y: JY(170), sectionId: ROME_SECTION_IDS.VIA_SACRA },
  // Forum Ruins
  { id: 'shard-coin-hoard',            x: X(2580), y: JY(215), sectionId: ROME_SECTION_IDS.FORUM_RUINS },
  { id: 'shard-votive-lamp',           x: X(3100), y: JY(265), sectionId: ROME_SECTION_IDS.FORUM_RUINS },
  { id: 'shard-bronze-fibula',         x: X(3500), y: JY(35),  sectionId: ROME_SECTION_IDS.FORUM_RUINS },
  // Thermae
  { id: 'shard-lead-pipe-stamp',       x: X(4450), y: JY(135), sectionId: ROME_SECTION_IDS.THERMAE },
  { id: 'shard-strigil',               x: X(5050), y: JY(245), sectionId: ROME_SECTION_IDS.THERMAE },
  // Basilica
  { id: 'shard-wax-tablet',            x: X(6310), y: JY(75),  sectionId: ROME_SECTION_IDS.BASILICA },
  { id: 'shard-senatorial-seal',       x: X(6620), y: JY(225), sectionId: ROME_SECTION_IDS.BASILICA },
  // Vault (final, plot-critical — connects to Egypt)
  { id: 'shard-egypt-import-record',   x: X(8200), y: JY(285), sectionId: ROME_SECTION_IDS.VAULT, critical: true },
];
