...
export const PLATFORMS = [
  ...
  { x: X(500), y: JY(280), width: 128, height: 18, label: 'opening scarab seal lower step' },
  { x: X(520), y: JY(235), width: 128, height: 18, label: 'opening scarab seal climb' },
  { x: X(540), y: JY(190), width: 128, height: 18, label: 'opening scarab seal high step' },
  { x: X(560), y: JY(145), width: 128, height: 18, label: 'opening scarab seal upper step' },
  { x: X(580), y: JY(100), width: 128, height: 18, label: 'opening scarab seal final step' },
  { x: X(600), y: JY(55), width: 128, height: 18, label: 'opening scarab seal summit' },
  { x: X(690), y: JY(190), width: 165, height: 18, label: 'opening climb return step' },
  ...
  { x: X(1295), y: JY(232), width: 112, height: 18, label: 'scarab seal climb capstone' },
  ...
  { x: X(1905), y: JY(308), width: 124, height: 18, label: 'sandfall warning slab' },
  { x: X(1980), y: JY(282), width: 138, height: 18, label: 'collapsing column step' },
...
export const SCARAB_SEAL_TRIGGER = {
  ...
  width: 46,
  height: 54,
  eventName: 'Scarab Seal',
  eventType: 'shrine-glow',
  shake: 0.16,
  duration: 3.0,
  messages: [
    'You found an artefact.',
    'The stone seal cracks open.',
    'This was not treasure. It was a warning.',
    'The Scarab Queen awakens.',
  ],
  bossIntroLine: 'You will never reach the expedition site.',
...
export const UPGRADES = [
  { id: 'basecamp-upgrade-voucher', name: 'Upgrade Voucher Cache', shortName: 'Voucher', emoji: 'V', x: X(680), y: JY(232), effect: 'Spend 2 shards to open a cache worth 6 Base Camp shards.', shardCost: 2, rewardShards: 6, cacheReward: true },
...
export const STORY_PROPS = [
  ...
  { id: 'opening-threshold-offering', sectionId: 'desert-entry', type: 'sacred-pedestal', x: X(520), y: JY(312), label: 'quiet offering plinth before the guardian threshold' },
  { id: 'early-scarab-seal-pedestal', sectionId: 'desert-entry', type: 'sacred-pedestal', x: X(600), y: JY(34), label: 'sacred pedestal holding the false Sacred Scarab Seal' },
  { id: 'early-scarab-seal', sectionId: 'desert-entry', type: 'guardian-seal', x: X(600), y: JY(8), label: 'false artefact Scarab Seal opening warning trigger' },
  ...
  { id: 'early-voucher-cache-marker', sectionId: 'desert-entry', type: 'sacred-pedestal', x: X(680), y: JY(312), label: 'offering cache plinth: spend 2 shards for an upgrade voucher' },
...
export const ENVIRONMENT_EVENTS = [
  ...
  { id: 'opening-warrior-guide-entry', sectionId: 'desert-entry', x: X(202), name: 'Warrior-Guide', message: 'I will guide you. Gather shards, recover tools, and treat the ancient site with respect.', type: 'dust-gust', duration: 2.6, shake: 0.08, dynamic: true, card: false },
  ...
  { id: 'opening-scarab-seal-climb', sectionId: 'desert-entry', x: X(560), name: 'Scarab Seal Plinth', message: 'Several stones lead upward toward a bright artefact.', type: 'shrine-glow', duration: 2.2, shake: 0.05, dynamic: true, card: false },
