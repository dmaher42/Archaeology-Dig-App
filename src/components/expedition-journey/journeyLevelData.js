...
export const ENEMIES = [
  { id: 'scarab-start-1', name: 'Start Path Scarab', type: 'scarab', emoji: 'B', x: X(292), y: JY(334), width: 30, height: 24, patrolMin: X(275), patrolMax: X(335), speed: 38, health: 1, damage: 2, openingRouteRamp: true, initialAttackCooldown: 1.15, playerKnockbackMultiplier: 0.45, attackPatternTuning: { windup: 0.58, duration: 0.24, cooldown: 1.62, recovery: 0.58, vulnerableAfter: 0.72, speed: 112, range: 28 }, shards: 1, encounterRole: 'first shard guard', protectsRouteId: 'temple-approach-seal', pressureHint: 'Introduces that enemies can drop relic shards for the first seal.' },
