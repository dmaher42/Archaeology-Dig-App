...
export const PLATFORMS = [
  ...
  { x: 126, y: JY(326), width: 114, height: 18, label: 'invisible marked lower pyramid ledge', invisible: true },
  { x: 248, y: JY(251), width: 374, height: 18, label: 'invisible marked first pyramid terrace', invisible: true },
  { x: 430, y: JY(91), width: 522, height: 18, label: 'invisible marked second pyramid terrace', invisible: true },
  { id: 'opening-scarab-seal-summit', x: 690, y: JY(-92), width: 448, height: 18, label: 'invisible marked scarab artefact platform', invisible: true },
