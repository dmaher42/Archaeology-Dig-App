...
export const ENEMIES = [
  { id: 'scarab-start-1', name: 'Start Path Scarab', type: 'scarab', emoji: 'B', x: X(255), y: JY(334), width: 30, height: 24, patrolMin: X(220), patrolMax: X(315), speed: 46, health: 2, damage: 3, shards: 1 },
  { id: 'scarab-dune-1', name: 'Dune Scarab', type: 'scarab', emoji: '🐞', x: X(365), y: JY(334), width: 30, height: 24, patrolMin: X(320), patrolMax: X(435), speed: 52, health: 2, damage: 4, shards: 1 },
  { id: 'scarab-ridge-1', name: 'Ridge Scarab', type: 'scarab', emoji: 'B', x: X(455), y: JY(334), width: 30, height: 24, patrolMin: X(420), patrolMax: X(505), speed: 48, health: 2, damage: 4, shards: 1 },
  { id: 'scorpion-start-1', name: 'Sand Scorpion', type: 'scorpion', emoji: 'S', x: X(505), y: JY(336), width: 36, height: 22, patrolMin: X(470), patrolMax: X(560), speed: 48, health: 2, damage: 6, shards: 2 },
  { id: 'scarab-pottery-1', name: 'Pottery Scarab', type: 'scarab', emoji: '🐞', x: X(535), y: JY(334), width: 32, height: 24, patrolMin: X(485), patrolMax: X(620), speed: 58, health: 2, damage: 5, shards: 1 },
  { id: 'scarab-survey-1', name: 'Survey Scarab', type: 'scarab', emoji: '🐞', x: X(625), y: JY(334), width: 30, height: 24, patrolMin: X(585), patrolMax: X(680), speed: 54, health: 2, damage: 4, shards: 1 },
  { id: 'scarab-scout-1', name: 'Scarab Scout', type: 'scarab', emoji: '🐞', x: X(705), y: JY(334), width: 34, height: 26, patrolMin: X(650), patrolMax: X(815), speed: 74, health: 2, damage: 7, shards: 2 },
  { id: 'sand-wisp-start-1', name: 'Sand Wisp', type: 'sand-wisp', emoji: 'W', x: X(760), y: JY(304), width: 32, height: 30, patrolMin: X(700), patrolMax: X(835), speed: 78, health: 2, damage: 6, shards: 2, flying: true },
  { id: 'scarab-1', name: 'Scarab', type: 'scarab', emoji: '🐞', x: X(890), y: JY(334), width: 34, height: 26, patrolMin: X(820), patrolMax: X(1040), speed: 80, health: 2, damage: 8, shards: 2 },
  { id: 'sand-wisp-ledge-1', name: 'Ledge Sand Wisp', type: 'sand-wisp', emoji: 'W', x: X(1010), y: JY(300), width: 32, height: 30, patrolMin: X(955), patrolMax: X(1115), speed: 72, health: 2, damage: 6, shards: 2, flying: true },
  { id: 'scarab-upper-route-1', name: 'Upper Route Scarab', type: 'scarab', emoji: 'B', x: X(1015), y: JY(334), width: 32, height: 24, patrolMin: X(965), patrolMax: X(1060), speed: 54, health: 2, damage: 5, shards: 1 },
  { id: 'scarab-seal-path-1', name: 'Seal Path Scarab', type: 'scarab', emoji: '🐞', x: X(1095), y: JY(334), width: 32, height: 24, patrolMin: X(1050), patrolMax: X(1160), speed: 56, health: 2, damage: 5, shards: 1 },
  { id: 'scorpion-warning-1', name: 'Stone Scorpion', type: 'scorpion', emoji: 'S', x: X(1170), y: JY(336), width: 38, height: 22, patrolMin: X(1120), patrolMax: X(1230), speed: 52, health: 2, damage: 7, shards: 2 },
  { id: 'snake-1', name: 'Sand Snake', type: 'snake', emoji: '🐍', x: X(1245), y: JY(330), width: 42, height: 30, patrolMin: X(1185), patrolMax: X(1325), speed: 62, health: 2, damage: 10, shards: 2 },
  { id: 'scarab-guardian-path-1', name: 'Guardian Path Scarab', type: 'scarab', emoji: 'B', x: X(1375), y: JY(334), width: 34, height: 26, patrolMin: X(1330), patrolMax: X(1435), speed: 60, health: 2, damage: 6, shards: 2 },
  ...
  { id: 'guardian-1', name: 'Stone Guardian', type: 'guardian', emoji: '🗿', x: X(2350), y: JY(318), width: 36, height: 42, patrolMin: X(2240), patrolMax: X(2580), speed: 72, health: 3, damage: 12, shards: 4 },
  ...
  { id: 'bat-2', name: 'Temple Bat', type: 'bat', emoji: '🦇', x: X(4025), y: JY(304), width: 34, height: 28, patrolMin: X(3930), patrolMax: X(4150), speed: 104, health: 2, damage: 8, shards: 3, flying: true },
