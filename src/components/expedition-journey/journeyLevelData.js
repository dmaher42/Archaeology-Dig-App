...
export const ENEMIES = [
  ...
  { id: 'scorpion-start-1', name: 'Sand Scorpion', type: 'scorpion', emoji: 'S', x: X(505), y: JY(336), width: 36, height: 22, patrolMin: X(470), patrolMax: X(560), speed: 48, health: 2, damage: 6, shards: 2, encounterRole: 'hazard guard', pressureHint: 'Guards the first sand ridge and forces a jump or counter choice.' },
  ...
  { id: 'sand-wisp-start-1', name: 'Sand Wisp', type: 'sand-wisp', emoji: 'W', x: X(760), y: JY(304), width: 32, height: 30, patrolMin: X(700), patrolMax: X(835), speed: 78, health: 2, damage: 6, shards: 2, flying: true, encounterRole: 'upper-route pressure', protectsRouteId: 'desert-upper-survey-route', pressureHint: 'Pressures the upper ledge route without blocking the lower path.' },
