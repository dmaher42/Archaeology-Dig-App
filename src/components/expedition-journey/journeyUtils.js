...
export const makeInitialState = ({ targetCivilisation, permanentUpgradeIds = [], permanentUpgradeEffects = {} } = {}) => ({
  ...
  collectedTimelineEvidenceIds: new Set(),
  romeTimelineEvidenceOrder: [],
  romeTimelineSolved: false,
  relicShardCount: 0,
  ...
  currentSceneId: JOURNEY_EXTERIOR_SCENE_ID,
