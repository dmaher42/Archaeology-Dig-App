...
export const JOURNEY_HORIZONTAL_SCALE = 8.82;
...
export const SCRIBE_CHAMBER_EXTERIOR_APPROACH_X = SCRIBE_CHAMBER_EXTERIOR_DOORWAY_X - 58;
export const OPENING_PYRAMID_DOORWAY_X = 925;
...
export const OPENING_BREACH_EXIT_X = 500;
export const DESERT_ENTRY_EXTERIOR_SPAWN_X = OPENING_BREACH_EXIT_X - PLAYER_WIDTH / 2;
