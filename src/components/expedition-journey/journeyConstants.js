...
export const PLAYER_HERO_SPRITE_ATLAS_JSON = 'assets/expedition/player/asha-player-production-spritesheet.json';
export const PLAYER_HERO_SPRITE_VERSION = 'asha-player-production-spritesheet-2026-05-19';
