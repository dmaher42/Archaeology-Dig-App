...
export const PLAYER_HERO_SPRITE_ATLAS_JSON = 'assets/expedition/player/asha-v5-spritesheet.json';
export const PLAYER_HERO_SPRITE_VERSION = 'asha-v5-candidate-2026-05-23';
