...
export const PLAYER_HERO_SPRITE_ATLAS_JSON = 'assets/expedition/player/asha-v2-production-candidate-spritesheet.json';
export const PLAYER_HERO_SPRITE_VERSION = 'asha-v2-production-candidate-2026-05-28';
