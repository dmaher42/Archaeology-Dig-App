...
export const PLAYER_HERO_SPRITE_ATLAS_JSON = 'assets/expedition/player/asha-hooded-warrior-explorer-spritesheet.json';
export const PLAYER_HERO_SPRITE_VERSION = 'asha-egypt-hooded-warrior-explorer-reference-2026-05-19';
