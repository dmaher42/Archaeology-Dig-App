...
export const ROME_SECTION_ATMOSPHERES = {
  'via-sacra': {
    skyTop:        '#c8b89a',
    skyBottom:     '#e8d8b8',
    haze:          'rgba(220, 200, 160, 0.22)',
    particle:      'ash motes',
    particleColor: 'rgba(210, 195, 165, 0.55)',
    fogColor:      'rgba(180, 160, 120, 0.18)',
    mood:          'cracked limestone road, volcanic haze, collapsed arches',
    color:         '#e8dcc8',
  ...
  'forum-ruins': {
    skyTop:        '#9a8870',
    skyBottom:     '#c4aa88',
    haze:          'rgba(200, 175, 130, 0.20)',
    particle:      'limestone dust',
    particleColor: 'rgba(220, 200, 160, 0.50)',
    fogColor:      'rgba(140, 115, 80, 0.20)',
    mood:          'fallen columns, ash-filled Forum, dusty afternoon light',
    color:         '#d4c9b8',
  ...
  'subterranean-thermae': {
    skyTop:        '#141c1c',
    skyBottom:     '#1e2a2a',
    haze:          'rgba(80, 120, 110, 0.20)',
    particle:      'steam wisps',
    particleColor: 'rgba(160, 200, 190, 0.40)',
    fogColor:      'rgba(30, 50, 50, 0.28)',
    mood:          'hypocaust steam, deep underground warmth, tile and lead',
    color:         '#2e3030',
  ...
  'basilica-interior': {
    skyTop:        '#3a3028',
    skyBottom:     '#5c4e40',
    haze:          'rgba(200, 180, 140, 0.18)',
    particle:      'dust motes',
    particleColor: 'rgba(230, 210, 175, 0.45)',
    fogColor:      'rgba(60, 48, 36, 0.22)',
    mood:          'clerestory light shafts, marble dust, silent apse',
    color:         '#c8c0b4',
  ...
  'sealed-vault': {
    skyTop:        '#0a100a',
    skyBottom:     '#1a2a1a',
    haze:          'rgba(100, 140, 100, 0.14)',
    particle:      'volcanic ash',
    particleColor: 'rgba(180, 200, 180, 0.38)',
    fogColor:      'rgba(10, 22, 10, 0.32)',
    mood:          'sealed archive dark, cold stone, 79 AD atmosphere preserved',
    color:         '#d4e8d4',
