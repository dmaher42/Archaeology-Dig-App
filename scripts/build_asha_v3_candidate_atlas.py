...
SOURCE_DIR = ROOT / "output/asha-production/v3-sprite-sources"
LOCOMOTION_SOURCE = SOURCE_DIR / "asha-v3-locomotion-source.png"
ACTION_SOURCE = SOURCE_DIR / "asha-v3-action-source.png"
UTILITY_SOURCE = SOURCE_DIR / "asha-v3-utility-source.png"
REFERENCE_SOURCE = ROOT / "output/asha-production/v3-sprite-sources/gemini-asha2-reference.jpg"
...
TARGET_JSON = TARGET_DIR / "asha-v3-production-candidate-spritesheet.json"
TARGET_PNG = TARGET_DIR / "asha-v3-production-candidate-spritesheet.png"
TARGET_REFERENCE = TARGET_DIR / "asha-v3-gemini-reference.jpg"
...
def main() -> None:
    ...
    metadata["source"] = "asha-v3-gemini-inspired-source-strip-candidate-2026-05-21"
    metadata["status"] = "production-candidate-needs-in-game-review"
    metadata["productionReference"] = TARGET_REFERENCE.name
    metadata["description"] = (
        "Asha V3 playable candidate atlas generated from Gemini-inspired source sheets and "
