...
- Follow-up sky-only pass: replaced `skyLight` with `desert-entry-sky-only-cracked-gold-2026-07-04.png`, an opaque 2172x724 warm amber/gold sunset sky with subtle cracked-gold shimmer and no terrain baked into the layer.
